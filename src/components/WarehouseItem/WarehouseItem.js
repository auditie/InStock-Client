...
const WarehouseItem = () => {
    return (
        <div className='warehouse-item'>
            <div className='warehouse-item__mobile'>
                <div>
                    <h4 className='warehouse-item__table-header'>WAREHOUSE</h4>
                    <a href='' className='warehouse-item__link'>Manhattan <img src={rightArrow} alt='right pointing arrow' className='warehouse-item__direct'></img></a>
            ...
            <div className='warehouse-item__manage'>
                <img src={deleteIcon} alt='trash can outline' className='warehouse-item__manage-delete'></img>
                <img src={editIcon} alt='pen edit outline' className='warehouse-item__manage-edit'></img>
            </div>
        </div>
    )
}
